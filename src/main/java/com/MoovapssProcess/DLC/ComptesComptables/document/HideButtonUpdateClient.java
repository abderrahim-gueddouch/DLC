...
public class HideButtonUpdateClient extends BaseDocumentExtension{
	@Override
	public boolean onAfterLoad() {
      ...
      for (IWidget iWidget : widgets)
      {
            ...
            {   
            	if(getWorkflowInstance().getValue("NomDEtape") == null || getWorkflowInstance().getValue("Desactiver") != null){
            		button.setHidden(true); 
            	}
            }
            if(button.getName().equals("Envoyer") || button.getName().equals("Retour") || button.getName().equals("Valider"))
            {   
            	if(getWorkflowInstance().getValue("NomDEtape") != null){
            		button.setHidden(true); 
            	}
            }
            if(button.getName().equals("Envoyer") || button.getName().equals("Retour") || button.getName().equals("Valider")){
