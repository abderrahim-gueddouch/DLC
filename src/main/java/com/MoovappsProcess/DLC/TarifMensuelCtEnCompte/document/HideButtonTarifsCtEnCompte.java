package com.MoovappsProcess.DLC.TarifMensuelCtEnCompte.document;
...
public class HideButtonTarifsCtEnCompte  extends BaseDocumentExtension{
	...
	public boolean onAfterLoad() {
      ...
      for (IWidget iWidget : widgets)
      {
            ...
            {   
            	if(getWorkflowInstance().getValue("NomDEtape16") == null ){
