package com.MoovappsProcess.Marketing.LeadsEntrants.document;
...
public class AffectationRDV extends BaseDocumentExtension{
...
//		viewcontroller.addNotEqualsConstraint(IProperty.System.REFERENCE, getWorkflowInstance().getValue(IProperty.System.REFERENCE));
	...
	public boolean onAfterLoad() {
		...
		Collection<IWorkflowInstance> collect=getleads();
